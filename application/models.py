...
class User(db.Model, UserMixin):
    ...
    following_users = db.relationship("Relation", foreign_key="Relation.id_following", backref="following", lazy=True)
    follower_users  = db.relationship("Relation", foreign_key="Relation.id_follower", backref="follower", lazy=True)
    post            = db.relationship("Post", backref="posts_owner", lazy=True)
...
class Post(db.Model):
    ...
    comments        = db.relationship("Comments", backref="commented", lazy=True)
